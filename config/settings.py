...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static', SVELTEKIT_BUILD_DIR]
...
TELEGRAM_NEW_BOT_ADMIN_APPROVAL = bool(getenv('TELEGRAM_NEW_BOT_ADMIN_APPROVAL', '1'))
